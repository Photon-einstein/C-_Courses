...
namespace WorkflowEngine
{
    internal class Program
    {
        ...
        {
            /* Exercise: Design a workflow engineDesign a workflow engine that takes a workflow object and runs it. 
             * A workflow is a series of steps or activities. The workflow engine class should have one method called Run() 
             * that takes a workflow, and then iterates over each activity in the workflow and runs it.
            ...
            e.AddActivity(new CallWebService());
            e.AddActivity(new ChangeStatusVideoRecord());
            e.AddActivity(new SendEmail());
            e.AddActivity(new UploadVideo());
            e.Run();
            /* freeze the console */
