...
namespace Stack
{
    internal class Program
    {
        static void Main(string[] args)
        {
             ...
             * fashion. Design a class called Stack with three methods. 
             * void Push(object obj)object Pop()void Clear()The Push() method stores the given object on 
             * top of the stack. We use the “object” type here so we can store any objects inside the stack. 
             * Remember the “object” class is the base of all classes in the .NET Framework. 
             * So any types can be automatically upcast to the object. Make sure to take into account the scenario 
             * that null is passed to this object. We should not store null references in the stack. 
             ...
             * When they are misused, they should throw exceptions. Again, thinking of all these edge cases, 
